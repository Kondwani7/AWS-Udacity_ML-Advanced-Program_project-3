...
# we create a CNN block and head that data will run through in a loop to train the model
#this will result in less and cleaner code
...
class MyModel(nn.Module):
    def __init__(self, num_classes: int = 1000, dropout: float = 0.7) -> None:
        ...
        for i in range(7):
            self.model.add_module(f"ConvBlock{i}",
